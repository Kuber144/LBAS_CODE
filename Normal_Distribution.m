...
mu_x = xMax / 2; % Mean for x-coordinates
sigma_x = xMax / 6; % Standard deviation for x-coordinates
mu_y = yMax / 2; % Mean for y-coordinates
sigma_y = yMax / 6; % Standard deviation for y-coordinates

% Generate random positions for sensors using normal distribution
sensorPositions = [normrnd(mu_x, sigma_x, numSensors, 1), ...
                  normrnd(mu_y, sigma_y, numSensors, 1)];
